#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_CAT_DOG_DETECTION_CONFIG_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_CAT_DOG_DETECTION_CONFIG_H_
...
#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_CAT_DOG_DETECTION_CONFIG_H_
